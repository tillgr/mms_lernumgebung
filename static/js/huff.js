document.addEventListener("DOMContentLoaded", function() {
	...
	const svg_image_cube_size = 360	 / 6;
	...
	function showPageUserInputs() {
		...
		function amountsChanged() {
			if(!(isNaN(input_r.value) || isNaN(input_g.value) || isNaN(input_b.value) || isNaN(input_v.value))) {
				...
				probability_r.style.color = "#000000";
				probability_g.style.color = "#000000";
				probability_b.style.color = "#000000";
				probability_v.style.color = "#000000";
	...
	function showPageEncoding() {
		...
		function evaluateProbabilities() {
			...
			input4.value = input4.value.replace(",", ".");
