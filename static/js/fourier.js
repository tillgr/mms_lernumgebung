document.addEventListener("DOMContentLoaded", function() {
	...
	function createSineWave() {
		...
		resetWave();
		indicateActiveElement(buttonSineWave);
	...
	function createCosineWave() {
		displayFunctionGraetz = false;
		resetWave();
		indicateActiveElement(buttonCosineWave);
	...
	function createSawWave() {
		displayFunctionGraetz = false;
		resetWave();
		indicateActiveElement(buttonSawWave);
		sliders_a[0].value = 99;
		sliders_a[1].value = -50;
		sliders_a[2].value = 33;
		sliders_a[3].value = -25;
		sliders_a[4].value = 20;
		sliders_a[5].value = -17;
		sliders_a[6].value = 14;
		sliders_a[7].value = -12;
		sliders_a[8].value = 11;
		sliders_a[9].value = -10;
	...
	function createSquareWave() {
		displayFunctionGraetz = false;
		resetWave();
		indicateActiveElement(buttonSquareWave);
		sliders_a[0].value = 99;
		sliders_a[2].value = 33;
		sliders_a[4].value = 20;
		sliders_a[6].value = 14;
	...
	function createTriangleWave() {
		displayFunctionGraetz = false;
		resetWave();
		indicateActiveElement(buttonTriangleWave);
		sliders_b[0].value = 99;
		sliders_b[2].value = 11;
		sliders_b[4].value = 4;
		sliders_b[6].value = 2;
		sliders_b[8].value = 1;
	...
	function createGraetzSine() {
		resetWave();
		indicateActiveElement(buttonGraetzSine);
		sliders_a[0].value = 99;
	...
	*/
	...
	function indicateActiveElement (sourceButton){
		let inactiveButtons =
		[
			buttonSineWave,
			buttonSawWave,
		...
		inactiveButtons.forEach((item)=>{
			if( item == sourceButton ) {
