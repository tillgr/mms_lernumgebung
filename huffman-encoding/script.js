document.addEventListener("DOMContentLoaded", function() {
	...
	function showPageUserInputs() {
		...
		document.getElementById("correct_inputs").style.display = "none";
		...
		function showPageCorrectInputs() {
			...
			//user_inputs_result_message.style.display = "none";

			document.getElementById("correct_inputs").style.display = "";
			user_inputs_wrong_result_message.style.display = "none";

			correct_input_r.style.color = "green";
			correct_input_g.style.color = "green";
			correct_input_b.style.color = "green";
			correct_input_v.style.color = "green";

			document.getElementById("correct_input_r").innerHTML = input_r.value = color_amounts[0];
			document.getElementById("correct_input_g").innerHTML = input_g.value = color_amounts[1];
			document.getElementById("correct_input_b").innerHTML = input_b.value = color_amounts[2];
			document.getElementById("correct_input_v").innerHTML = input_v.value = color_amounts[3];
	...
	function showPageEncoding() {
		...
		document.getElementById("encoding_container").style.display = "block";
		...
		buttonNext.onclick = evaluateProbabilities;
		...
		function evaluateProbabilities() {
			...
			if(input1.value == color_probabilities[0] && input2.value == color_probabilities[1] && input3.value == color_probabilities[2] && input4.value == color_probabilities[3]) {
				...
				if(tries_encoding_probabilities > 0) {
					...
					buttonNext.onclick = showCorrectProbabilities;
				}
			}
		...
		function showCorrectProbabilities() {
			...
			buttonNext.onclick = showCheckboxes;
		...
		function showCheckboxes() {
			...
			buttonNext.onclick = evaluateCheckboxes;
		}
		...
		function evaluateCheckboxes() {
			...
			if(evaluate()) {
				...
				if(tries_encoding_checkboxes > 0) {
					...
					encoding_amount_tries_message.style.display = "none";
					buttonNext.onclick = showCorrectCheckboxes;
				}
		...
		function showCorrectCheckboxes() {
			...
			buttonNext.onclick = showNumbers;
		}
		...
		function showNumbers() {
			...
			buttonNext.onclick = evaluateNumbers;
		}
		...
		function evaluateNumbers() {
			...
			if(evaluate()) {
				...
				if(tries_encoding_numbers > 0) {
					...
					encoding_amount_tries_message.style.display = "none";
					buttonNext.onclick = showCorrectNumbers;
				}
		...
		function showCorrectNumbers() {
			...
			buttonNext.onclick = showPageConclusion;
		}
